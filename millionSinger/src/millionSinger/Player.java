...
public class Player extends JFrame {
	...
	public Player(){
		...
		title = new JLabel("�ʸU�j�q�P",SwingConstants.CENTER);
		title.setForeground(Color.WHITE);
		title.setOpaque(true);
		title.setFont(new Font("�L�n������", Font.BOLD,48));
